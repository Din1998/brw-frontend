...
import img from '@/assets/image/common/intro.png'
import img2 from '@/assets/image/common/offer-bg2.png'
                                    ...
                                    <Row>
                                        <Col lg={8}>
                                            <div className={styles.section_content}>
                                                <h6 className={styles.title}>Providing Large Yachts For A Perfect</h6>
