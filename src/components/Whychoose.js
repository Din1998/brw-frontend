...
import img1 from '@/assets/image/common/whychoose.png'

import WhyChooseKey from '@/components/whychoose-key/WhyChooseKey'
                            ...
                            <Row>
                                <Col lg={8}>
                                    ...
                                    <Row className="gx-0">
                                        ...
                                        const isLastFour = index >= displayedKeyContent.length - 2; 
                                        const className = isLastFour ? 'last_card2' : ''; 
